...
urlpatterns = [
    ...
    path(
        "diagram/<int:pk>/changelog", ObjectChangeLogView.as_view(), name="diagram_changelog", kwargs={"model": Diagram}
    ),
    ...
    path(
        "diagramassociation/<int:pk>/delete", DiagramAssociationDeleteView.as_view(), name="diagramassociation_delete"
    ),
    ...
    path(
        "diagramassociation/delete", DiagramAssociationBulkDeleteView.as_view(), name="diagramassociation_bulk_delete"
    ),
    path(
        "diagramassociation/<int:pk>/changelog",
        ObjectChangeLogView.as_view(),
        name="diagramassociation_changelog",
        kwargs={"model": DiagramAssociation},
    ),
]
